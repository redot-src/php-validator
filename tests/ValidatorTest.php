...
test('Test Rule: required', function () {
...
test('Test Rule: pattern', function () {
...
test('Test Rule: between', function () {
...
test('Test Rule: contains', function () {
...
test('Test Rule: doesntContain', function () {
...
test('Test Rule: string', function () {
...
test('Test Rule: integer', function () {
...
test('Test Rule: double', function () {
...
test('Test Rule: object', function () {
...
test('Test Rule: truthy', function () {
